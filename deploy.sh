...
echo_blue "📦 备份 content/posts 到 vanbak..."
mkdir -p /Users/fanweijun/vanbak
BACKUP_FILE="/Users/fanweijun/vanbak/posts_backup_$(date +'%Y%m%d_%H%M%S').tar.gz"
tar -czf "${BACKUP_FILE}" -C "${SCRIPT_DIR}/content" posts
echo_info "备份已保存: ${BACKUP_FILE}"
